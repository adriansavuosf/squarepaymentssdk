...
class CatalogDiscount implements ArrayAccess
{
    ...
    /**
     * $percentage The percentage of the discount as a string representation of a decimal number, using a `.` as
     * the decimal separator and without a `%` sign. A value of `7.5` corresponds to `7.5%`.
    ...
    private $percentage;
    /**
     * $amount_money The amount of the discount. Specify an amount of `0` if `discount_type` is `VARIABLE_AMOUNT`.
     * Do not include this field for percentage-based or variable discounts.
     * @var \SquareConnect\Model\Money
     */
    private $amount_money;
    /**
     * $pin_required Indicates whether a mobile staff member needs to enter their PIN to apply the discount to a
     * payment in the Square Point of Sale app.
     * @var bool
     */
    private $pin_required;
    /**
    ...
    /**
     * Sets discount_type
     * @param string $discount_type Indicates whether the discount is a fixed amount or percentage, or entered at
     * the time of sale. See [CatalogDiscountType](#type-catalogdiscounttype) for all possible values.
     * @return $this
     */
    ...
    /**
     * Sets percentage
     * @param string $percentage The percentage of the discount as a string representation of a decimal number,
     * using a `.` as the decimal separator and without a `%` sign. A value of `7.5` corresponds to `7.5%`.
     * Specify a percentage of `0` if `discount_type` is `VARIABLE_PERCENTAGE`.
     * Do not include this field for amount-based or variable discounts.
     * @return $this
     */
    ...
    /**
     * Sets amount_money
     * @param \SquareConnect\Model\Money $amount_money The amount of the discount. Specify an amount of `0`
     * if `discount_type` is `VARIABLE_AMOUNT`.  Do not include this field for percentage-based or variable discounts.
     * @return $this
     */
    ...
    /**
     * Sets pin_required
     * @param bool $pin_required Indicates whether a mobile staff member needs to enter their PIN to apply the
