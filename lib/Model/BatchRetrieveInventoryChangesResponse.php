...
class BatchRetrieveInventoryChangesResponse implements ArrayAccess
{
    ...
    private $errors;
    /**
     * $changes The current calculated inventory changes for the requested object(s) and location(s).
    ...
    /**
     * Sets changes
     * @param \SquareConnect\Model\InventoryChange[] $changes The current calculated inventory changes
     * for the requested object(s) and location(s).
     * @return $this
     */
