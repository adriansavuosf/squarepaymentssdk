...
class CreateOrderRequestLineItem implements ArrayAccess
{
    ...
    /**
     * $name Only used for ad hoc line items. The name of the line item. This value cannot exceed 500 characters.
     * Do not provide a value for this field if you provide a value for `catalog_object_id`.
     * @var string
     */
    private $name;
    /**
     * $quantity The quantity to purchase, as a string representation of a number.  This string must have a positive
     * integer value.
     * @var string
     */
    private $quantity;
    /**
     * $base_price_money The base price for a single unit of the line item.  `base_price_money` is required for ad hoc
     * line items and variable priced [CatalogItemVariation](#type-catalogitemvariation)s. If both `catalog_object_id`
     * and `base_price_money` are set, `base_price_money` will override the CatalogItemVariation's price.
     * @var \SquareConnect\Model\Money
     */
    private $base_price_money;
    /**
     * $variation_name Only used for ad hoc line items. The variation name of the line item. This value cannot exceed
     * 255 characters.  If this value is not set for an ad hoc line item, the default value of `Regular` is used.
    ...
    private $note;
    /**
     * $catalog_object_id Only used for Catalog line items. The catalog object ID for an existing
     * [CatalogItemVariation](#type-catalogitemvariation).  Do not provide a value for this field if you provide a
     * value for `name` and `base_price_money`.
     * @var string
     */
    ...
    /**
     * Sets name
     * @param string $name Only used for ad hoc line items. The name of the line item. This value cannot exceed 500
     * characters.  Do not provide a value for this field if you provide a value for `catalog_object_id`.
     * @return $this
     */
    ...
    /**
     * Sets quantity
     * @param string $quantity The quantity to purchase, as a string representation of a number.  This string must have
     ...
     * `base_price_money` is required for ad hoc line items and variable priced
     * [CatalogItemVariation](#type-catalogitemvariation)s. If both `catalog_object_id` and `base_price_money` are set,
     * `base_price_money` will override the CatalogItemVariation's price.
     * @return $this
     */
    ...
    /**
     * Sets variation_name
     * @param string $variation_name Only used for ad hoc line items. The variation name of the line item.
     * This value cannot exceed 255 characters.  If this value is not set for an ad hoc line item, the default value of
     * `Regular` is used.  Do not provide a value for this field if you provide a value for the `catalog_object_id`.
     * @return $this
     */
     ...
     * @param string $catalog_object_id Only used for Catalog line items. The catalog object ID for an existing
     * [CatalogItemVariation](#type-catalogitemvariation).  Do not provide a value for this field if you provide a
     * value for `name` and `base_price_money`.
     * @return $this
     */
    ...
    /**
     * Sets modifiers
     * @param \SquareConnect\Model\CreateOrderRequestModifier[] $modifiers Only used for Catalog line items.
     * The modifiers to include on the line item.
     * @return $this
     */
