...
class V1Tender implements ArrayAccess
{
    ...
    public static $swaggerTypes = [
        ...
        'tendered_money' => \SquareConnect\Model\V1Money::class,
        'change_back_money' => \SquareConnect\Model\V1Money::class,
    ...
    /**
     * $payment_note Notes entered by the merchant about the tender at the time of payment, if any.
    ...
    /**
     * $is_exchange Indicates whether or not the tender is associated with an exchange.
     * If is_exchange is true, the tender represents the value of goods returned in an exchange not the actual money
     * paid. The exchange value reduces the tender amounts needed to pay for items purchased in the exchange.
     * @var bool
     */
    private $is_exchange;
    ...
    /**
     * Sets payment_note
     * @param string $payment_note Notes entered by the merchant about the tender at the time of payment, if any.
     * Typically only present for tender with the type: OTHER.
     * @return $this
     */
    ...
    /**
     * Sets refunded_money
     * @param \SquareConnect\Model\V1Money $refunded_money The total of all refunds applied to this tender.
    ...
    /**
     * Sets is_exchange
     * @param bool $is_exchange Indicates whether or not the tender is associated with an exchange.
     * If is_exchange is true, the tender represents the value of goods returned in an exchange not the actual money
     * paid. The exchange value reduces the tender amounts needed to pay for items purchased in the exchange.
     * @return $this
     */
