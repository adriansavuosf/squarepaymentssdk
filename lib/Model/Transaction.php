...
class Transaction implements ArrayAccess
{
    ...
    private $refunds;
    /**
     * $reference_id If the transaction was created with the [Charge](#endpoint-charge) endpoint, this value is the
     * same as the value provided for the `reference_id` parameter in the request to that endpoint. Otherwise,
     * it is not set.
     * @var string
     */
    ...
    private $product;
    /**
     * $client_id If the transaction was created in the Square Point of Sale app, this value is the ID generated for
     * the transaction by Square Point of Sale.  This ID has no relationship to the transaction's canonical `id`,
     * which is generated by Square's backend servers. This value is generated for bookkeeping purposes, in case the
     * transaction cannot immediately be completed (for example, if the transaction is processed in offline mode).
    ...
    /**
     * Sets reference_id
     * @param string $reference_id If the transaction was created with the [Charge](#endpoint-charge) endpoint, this
     * value is the same as the value provided for the `reference_id` parameter in the request to that endpoint.
    ...
    /**
     * Sets client_id
     * @param string $client_id If the transaction was created in the Square Point of Sale app, this value is the ID
     * generated for the transaction by Square Point of Sale.  This ID has no relationship to the transaction's
     * canonical `id`, which is generated by Square's backend servers. This value is generated for bookkeeping
     * purposes, in case the transaction cannot immediately be completed (for example, if the transaction is processed
     * in offline mode).  It is not currently possible with the Connect API to perform a transaction lookup by this
     * value.
     * @return $this
     */
