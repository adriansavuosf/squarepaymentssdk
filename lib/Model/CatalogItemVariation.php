...
class CatalogItemVariation implements ArrayAccess
{
    ...
    private $sku;
    /**
     * $upc The item variation's UPC, if any. Searchable in the Connect API.
    ...
    private $upc;
    /**
     * $ordinal The order in which this item variation should be displayed.
     * This value is read-only. On writes, the ordinal for each item variation within a parent
     * [CatalogItem](#type-catalogitem) is set according to the item variations's position.
     ...
     */
    private $location_overrides;
    /**
     * $track_inventory If `true`, inventory tracking is active for the variation.
     * @var bool
     */
    private $track_inventory;
    /**
     * $inventory_alert_type Indicates whether the item variation displays an alert when its inventory quantity
     * is less than or equal to its `inventory_alert_threshold`. See [InventoryAlertType](#type-inventoryalerttype)
     * for all possible values.
     * @var string
     */
    private $inventory_alert_type;
    /**
     * $inventory_alert_threshold If the inventory quantity for the variation is less than or equal to this value and
     * `inventory_alert_type` is `LOW_QUANTITY`, the variation displays an alert in the merchant dashboard.
     * This value is always an integer.
     * @var int
     */
    private $inventory_alert_threshold;
    /**
     * $user_data Arbitrary user metadata to associate with the item variation. Cannot exceed 255 characters.
     * Searchable.
     * @var string
     */
    private $user_data;
    /**
     * $service_duration If the [CatalogItem](#type-catalogitem) that owns this item variation is of type
     * `APPOINTMENTS_SERVICE`, then this is the duration of the service in milliseconds.
     * For example, a 30 minute appointment would have the value `1800000`,
     * which is equal to 30 (minutes) * 60 (seconds per minute) * 1000 (milliseconds per second).
     * @var int
     */
    private $service_duration;
    ...
    /**
     * Sets item_id
     * @param string $item_id The ID of the [CatalogItem](#type-catalogitem) associated with this item variation.
     * Searchable.
     * @return $this
     */
    ...
    /**
     * Sets upc
     * @param string $upc The item variation's UPC, if any. Searchable in the Connect API.
     * This field is only exposed in the Connect API. It is not exposed in Square's Dashboard,
     * Square Point of Sale app or Retail Point of Sale app.
     * @return $this
     */
    ...
    /**
     * Sets ordinal
     * @param int $ordinal The order in which this item variation should be displayed. This value is read-only.
     * On writes, the ordinal for each item variation within a parent [CatalogItem](#type-catalogitem)
     * is set according to the item variations's position. On reads, the value is not guaranteed
     * to be sequential or unique.
     * @return $this
     */
    ...
    /**
     * Sets pricing_type
     * @param string $pricing_type Indicates whether the item variation's price is fixed or determined
     * at the time of sale. See [CatalogPricingType](#type-catalogpricingtype) for all possible values.
     * @return $this
     */
     ...
     * @param \SquareConnect\Model\ItemVariationLocationOverrides[] $location_overrides Per-[location](#type-location)
     * price and inventory overrides.
     * @return $this
     */
     ...
     * @param string $inventory_alert_type Indicates whether the item variation displays an alert when its inventory
     ...
     * @param int $inventory_alert_threshold If the inventory quantity for the variation is less than or equal
     * to this value and `inventory_alert_type` is `LOW_QUANTITY`, the variation displays an alert
     * in the merchant dashboard.  This value is always an integer.
     * @return $this
     */
    ...
    /**
     * Sets user_data
     * @param string $user_data Arbitrary user metadata to associate with the item variation.
     * Cannot exceed 255 characters. Searchable.
     * @return $this
     */
     ...
     * @param int $service_duration If the [CatalogItem](#type-catalogitem) that owns this item variation is of type
     * `APPOINTMENTS_SERVICE`, then this is the duration of the service in milliseconds.
     * For example, a 30 minute appointment would have the value `1800000`,
     * which is equal to 30 (minutes) * 60 (seconds per minute) * 1000 (milliseconds per second).
     * @return $this
