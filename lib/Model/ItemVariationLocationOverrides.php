...
class ItemVariationLocationOverrides implements ArrayAccess
{
    ...
    private $location_id;
    /**
     * $price_money The price of the [CatalogItemVariation](#type-catalogitemvariation) at the given
     * [location](#type-location), or blank for variable pricing.
     * @var \SquareConnect\Model\Money
     */
    private $price_money;
    /**
     * $pricing_type The pricing type (fixed or variable) for the [CatalogItemVariation](#type-catalogitemvariation)
     * at the given [location](#type-location). See [CatalogPricingType](#type-catalogpricingtype) for all possible
     * values.
     * @var string
     */
    private $pricing_type;
    /**
     * $track_inventory If `true`, inventory tracking is active for the
     * [CatalogItemVariation](#type-catalogitemvariation) at this [location](#type-location).
     * @var bool
     */
    private $track_inventory;
    /**
     * $inventory_alert_type Indicates whether the [CatalogItemVariation](#type-catalogitemvariation) displays an
     * alert when its inventory quantity is less than or equal to its `inventory_alert_threshold`.
    ...
    /**
     * Sets price_money
     * @param \SquareConnect\Model\Money $price_money The price of the
     * [CatalogItemVariation](#type-catalogitemvariation) at the given [location](#type-location), or blank for
     * variable pricing.
     * @return $this
     */
    ...
    /**
     * Sets pricing_type
     * @param string $pricing_type The pricing type (fixed or variable) for the
     * [CatalogItemVariation](#type-catalogitemvariation) at the given [location](#type-location).
     ...
     * @param bool $track_inventory If `true`, inventory tracking is active for the
     * [CatalogItemVariation](#type-catalogitemvariation) at this [location](#type-location).
     * @return $this
     */
     ...
     * @param string $inventory_alert_type Indicates whether the [CatalogItemVariation](#type-catalogitemvariation)
     * displays an alert when its inventory quantity is less than or equal to its `inventory_alert_threshold`.
     * See [InventoryAlertType](#type-inventoryalerttype) for all possible values.
     * @return $this
     */
     ...
     * @param int $inventory_alert_threshold If the inventory quantity for the variation is less than or equal to this
     * value and `inventory_alert_type` is `LOW_QUANTITY`, the variation displays an alert in the merchant dashboard.
     * This value is always an integer.
     * @return $this
     */
