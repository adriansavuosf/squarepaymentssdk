...
class V1PaymentTax implements ArrayAccess
{
    ...
    /**
     * $rate The rate of the tax, as a string representation of a decimal number. A value of 0.07 corresponds to a rate
     * of 7%.
     * @var string
     */
    private $rate;
    ...
    /**
     * Sets rate
     * @param string $rate The rate of the tax, as a string representation of a decimal number.
    ...
    /**
     * Sets fee_id
     * @param string $fee_id The ID of the tax, if available. Taxes applied in older versions of Square Register might
     * not have an ID.
     * @return $this
     */
