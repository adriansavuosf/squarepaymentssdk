...
class V1Employee implements ArrayAccess
{
    ...
    private $last_name;
    /**
     * $role_ids The ids of the employee's associated roles. Currently, you can specify only one or zero roles per
     * employee.
     * @var string[]
     */
    private $role_ids;
     ...
     * @var string[]
     */
    private $authorized_location_ids;
    /**
    ...
    private $email;
    /**
     * $status CWhether the employee is ACTIVE or INACTIVE. Inactive employees cannot sign in to Square Register.
    ...
    /**
     * Sets role_ids
     * @param string[] $role_ids The ids of the employee's associated roles. Currently, you can specify only one or
     * zero roles per employee.
     * @return $this
     */
    ...
    /**
     * Sets status
     * @param string $status CWhether the employee is ACTIVE or INACTIVE. Inactive employees cannot sign in to Square
     * Register.Merchants update this field from the Square Dashboard.
     * @return $this
     */
