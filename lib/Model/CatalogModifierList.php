...
class CatalogModifierList implements ArrayAccess
{
    ...
    private $name;
    /**
     * $selection_type Indicates whether multiple options from the [CatalogModifierList](#type-catalogmodifierlist)
     * can be applied to a single [CatalogItem](#type-catalogitem).
     * See [CatalogModifierListSelectionType](#type-catalogmodifierlistselectiontype) for all possible values.
     * @var string
     */
    private $selection_type;
    /**
     * $modifiers The options included in the [CatalogModifierList](#type-catalogmodifierlist).
    ...
    /**
     * Sets selection_type
     * @param string $selection_type Indicates whether multiple options from the
     * [CatalogModifierList](#type-catalogmodifierlist) can be applied to a single [CatalogItem](#type-catalogitem).
     * See [CatalogModifierListSelectionType](#type-catalogmodifierlistselectiontype) for all possible values.
     * @return $this
     */
    ...
    /**
     * Sets modifiers
     * @param \SquareConnect\Model\CatalogObject[] $modifiers The options included in the
     * [CatalogModifierList](#type-catalogmodifierlist). You must include at least one
     * [CatalogModifier](#type-catalogmodifier). Each [CatalogObject](#type-catalogobject) must have type `MODIFIER`
     * and contain [CatalogModifier](#type-catalogmodifier) data.
     * @return $this
     */
