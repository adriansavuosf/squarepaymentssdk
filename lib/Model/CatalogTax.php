...
class CatalogTax implements ArrayAccess
{
     ...
     * See [TaxCalculationPhase](#type-taxcalculationphase) for all possible values.
     * @var string
     */
    private $calculation_phase;
    /**
     * $inclusion_type Whether the tax is `ADDITIVE` or `INCLUSIVE`.
     * See [TaxInclusionType](#type-taxinclusiontype) for all possible values.
     * @var string
     */
    private $inclusion_type;
    /**
     * $percentage The percentage of the tax in decimal form, using a `'.'` as the decimal separator and without
     ...
     * @param string $calculation_phase Whether the tax is calculated based on a payment's subtotal or total.
     * See [TaxCalculationPhase](#type-taxcalculationphase) for all possible values.
     * @return $this
     */
    ...
    /**
     * Sets inclusion_type
     * @param string $inclusion_type Whether the tax is `ADDITIVE` or `INCLUSIVE`.
     * See [TaxInclusionType](#type-taxinclusiontype) for all possible values.
     * @return $this
     */
    ...
    /**
     * Sets percentage
     * @param string $percentage The percentage of the tax in decimal form, using a `'.'` as the decimal separator
     * and without a `'%'` sign. A value of `7.5` corresponds to 7.5%.
     * @return $this
     */
     ...
     * @param bool $applies_to_custom_amounts If `true`, the fee applies to custom amounts entered into the
     * Square Point of Sale app that are not associated with a particular [CatalogItem](#type-catalogitem).
     * @return $this
     */
