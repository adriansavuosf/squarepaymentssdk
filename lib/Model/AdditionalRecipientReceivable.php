...
class AdditionalRecipientReceivable implements ArrayAccess
{
    ...
    /**
     * $transaction_location_id The ID of the location that created the receivable.
     * This is the location ID on the associated transaction.
     * @var string
     */
    private $transaction_location_id;
    /**
     ...
     * @param string $transaction_location_id The ID of the location that created the receivable.
     * This is the location ID on the associated transaction.
     * @return $this
     */
    ...
    /**
     * Sets refunds
     * @param \SquareConnect\Model\AdditionalRecipientReceivableRefund[] $refunds
