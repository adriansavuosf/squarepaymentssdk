...
class Address implements ArrayAccess
{
     ...
     * Fields that start with `address_line` provide the address's most specific details, like street number,
     * street name, and building name. They do *not* provide less specific details like city, state/province,
     ...
     * @param string $administrative_district_level_1 A civil entity within the address's country.
     ...
     * @param string $administrative_district_level_2 A civil entity within the address's
     ...
     * @param string $administrative_district_level_3 A civil entity within the address's
