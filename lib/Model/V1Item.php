...
class V1Item implements ArrayAccess
{
    ...
    public static $swaggerTypes = [
        ...
        'master_image' => \SquareConnect\Model\V1ItemImage::class,
        'category' => \SquareConnect\Model\V1Category::class,
    ...
    /**
     * $id The item's ID. Must be unique among all entity IDs ever provided on behalf of the merchant.
    ...
    private $type;
    /**
     * $color The color of the discount's display label in Square Register, if not the default color.
     * The default color is 9da2a6.
     * @var string
     */
    private $color;
    /**
     * $abbreviation The text of the item's display label in Square Register. Only up to the first five characters of
     * the string are used.
     * @var string
     */
    ...
    /**
     * Sets id
     * @param string $id The item's ID. Must be unique among all entity IDs ever provided on behalf of the merchant.
     * You can never reuse an ID. This value can include alphanumeric characters, dashes (-), and underscores (_).
     * @return $this
     */
    ...
    /**
     * Sets abbreviation
     * @param string $abbreviation The text of the item's display label in Square Register. Only up to the first five
    ...
    /**
     * Sets visibility
     * @param string $visibility Indicates whether the item is viewable from the merchant's online store (PUBLIC) or
     * PRIVATE.
     * @return $this
     */
    ...
    /**
     * Sets variations
     * @param \SquareConnect\Model\V1Variation[] $variations The item's variations. You must specify at least one
     * variation.
     * @return $this
     */
