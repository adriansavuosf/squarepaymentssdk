...
class V1Timecard implements ArrayAccess
{
     ...
     * @var string
     */
    private $clockin_time;
    /**
     * $clockout_time The clock-out time for the timecard, in ISO 8601 format.
     * Provide this value only if importing timecard information from another system.
     * @var string
     */
    private $clockout_time;
    /**
     * $clockin_location_id The ID of the location the employee clocked in from, if any.
     * @var string
     */
    private $clockin_location_id;
    /**
     * $clockout_location_id The ID of the location the employee clocked out from.
     * Provide this value only if importing timecard information from another system.
     * @var string
     */
    private $clockout_location_id;
    /**
    ...
    /**
     * Sets clockout_time
     * @param string $clockout_time The clock-out time for the timecard, in ISO 8601 format.
     * Provide this value only if importing timecard information from another system.
     * @return $this
     */
     ...
     * @param string $clockout_location_id The ID of the location the employee clocked out from.
     * Provide this value only if importing timecard information from another system.
     * @return $this
     */
