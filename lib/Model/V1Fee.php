...
class V1Fee implements ArrayAccess
{
    ...
    private $name;
    /**
     * $rate The rate of the fee, as a string representation of a decimal number. A value of 0.07 corresponds to a
     * rate of 7%.
     * @var string
     */
    private $rate;
    ...
    /**
     * $applies_to_custom_amounts If true, the fee applies to custom amounts entered into Square Register that are not
     * associated with a particular item.
     * @var bool
     */
    private $applies_to_custom_amounts;
    /**
     ...
     * @var string
     */
    private $inclusion_type;
    /**
     * $type In countries with multiple classifications for sales taxes, indicates which classification the fee falls
     * under. Currently relevant only to Canadian merchants.
     * @var string
     */
    private $type;
    ...
    /**
     * Sets rate
     * @param string $rate The rate of the fee, as a string representation of a decimal number. A value of 0.07
     ...
     * @param string $adjustment_type The type of adjustment the fee applies to a payment. Currently, this value is TAX
     * for all fees.
     * @return $this
     */
     ...
     * @param bool $applies_to_custom_amounts If true, the fee applies to custom amounts entered into Square Register
     * that are not associated with a particular item.
     * @return $this
     */
    ...
    /**
     * Sets enabled
     * @param bool $enabled If true, the fee is applied to all appropriate items. If false, the fee is not applied at
     * all.
     * @return $this
     */
    ...
    /**
     * Sets type
     * @param string $type In countries with multiple classifications for sales taxes, indicates which classification
     * the fee falls under. Currently relevant only to Canadian merchants.
     * @return $this
     */
