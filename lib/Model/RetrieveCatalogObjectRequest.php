...
class RetrieveCatalogObjectRequest implements ArrayAccess
{
     ...
     * requested object, as follows:  If the `object` field of the response contains a [CatalogItem](#type-catalogitem),
     ...
     * [CatalogItemVariation](#type-catalogitemvariation), its parent [CatalogItem](#type-catalogitem) will be
     * returned in the `related_objects` field of the response.  Default value: `false`
     * @var bool
     */
     ...
     * the requested object, as follows:  If the `object` field of the response contains a
