...
class V1CreateRefundRequest implements ArrayAccess
{
    ...
    /**
     * $payment_id The ID of the payment to refund. If you're creating a PARTIAL refund for a split tender payment,
     * instead provide the id of the particular tender you want to refund. See Split Tender Payments for details.
     * @var string
     */
    private $payment_id;
    /**
    ...
    /**
     * $request_idempotence_key An optional key to ensure idempotence if you issue the same PARTIAL refund request more
     * than once.
     * @var string
     */
    private $request_idempotence_key;
    ...
    /**
     * Sets payment_id
     * @param string $payment_id The ID of the payment to refund. If you're creating a PARTIAL refund for a split
     * tender payment, instead provide the id of the particular tender you want to refund. See Split Tender Payments
     * for details.
     * @return $this
     */
    ...
    /**
     * Sets refunded_money
     * @param \SquareConnect\Model\V1Money $refunded_money The amount of money to refund. Required only for PARTIAL
     * refunds.
     * @return $this
     */
     ...
     * @param string $request_idempotence_key An optional key to ensure idempotence if you issue the same PARTIAL
