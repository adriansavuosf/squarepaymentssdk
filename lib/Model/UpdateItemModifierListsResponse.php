...
class UpdateItemModifierListsResponse implements ArrayAccess
{
    ...
    private $errors;
    /**
     * $updated_at The database [timestamp](#workingwithdates) of this update in RFC 3339 format, e.g.,
    ...
    /**
     * Sets updated_at
     * @param string $updated_at The database [timestamp](#workingwithdates) of this update in RFC 3339 format, e.g.,
     * \"2016-09-04T23:59:33.123Z\".
     * @return $this
     */
