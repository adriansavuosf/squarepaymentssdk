...
class V1ModifierList implements ArrayAccess
{
    ...
    private $name;
    /**
     * $selection_type Indicates whether MULTIPLE options or a SINGLE option from the modifier list can be applied to a
     * single item.
     * @var string
     */
    ...
    /**
     * Sets selection_type
     * @param string $selection_type Indicates whether MULTIPLE options or a SINGLE option from the modifier list can
