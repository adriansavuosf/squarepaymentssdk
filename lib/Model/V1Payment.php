...
class V1Payment implements ArrayAccess
{
    ...
    public static $swaggerTypes = [
        ...
        'created_at' => 'string',
        'creator_id' => 'string',
        'device' => \SquareConnect\Model\Device::class,
        'payment_url' => 'string',
        'receipt_url' => 'string',
        'inclusive_tax_money' => \SquareConnect\Model\V1Money::class,
        'additive_tax_money' => \SquareConnect\Model\V1Money::class,
        'tax_money' => \SquareConnect\Model\V1Money::class,
        'tip_money' => \SquareConnect\Model\V1Money::class,
        'discount_money' => \SquareConnect\Model\V1Money::class,
        'total_collected_money' => \SquareConnect\Model\V1Money::class,
        'processing_fee_money' => \SquareConnect\Model\V1Money::class,
        'net_total_money' => \SquareConnect\Model\V1Money::class,
        'refunded_money' => \SquareConnect\Model\V1Money::class,
        'swedish_rounding_money' => \SquareConnect\Model\V1Money::class,
        'gross_sales_money' => \SquareConnect\Model\V1Money::class,
        'net_sales_money' => \SquareConnect\Model\V1Money::class,
    ...
    private $device;
    /**
     * $payment_url The URL of the payment's detail page in the merchant dashboard. The merchant must be signed in to
     * the merchant dashboard to view this page.
     * @var string
     */
    private $payment_url;
    /**
     * $receipt_url The URL of the receipt for the payment. Note that for split tender payments, this URL corresponds
     * to the receipt for the first tender listed in the payment's tender field. Each Tender object has its own
     * receipt_url field you can use to get the other receipts associated with a split tender payment.
     * @var string
     */
    private $receipt_url;
    /**
     ...
     */
    private $inclusive_tax_money;
    /**
     * $additive_tax_money The sum of all additive taxes associated with the payment.
     * @var \SquareConnect\Model\V1Money
     */
    private $additive_tax_money;
    /**
     * $tax_money The total of all taxes applied to the payment. This is always the sum of inclusive_tax_money and
     * additive_tax_money.
     * @var \SquareConnect\Model\V1Money
     */
    private $tax_money;
     ...
     * @var \SquareConnect\Model\V1Money
     */
    private $total_collected_money;
    /**
     * $processing_fee_money The total of all processing fees collected by Square for the payment.
     * @var \SquareConnect\Model\V1Money
     */
    private $processing_fee_money;
    /**
     * $net_total_money The amount to be deposited into the merchant's bank account for the payment.
     * @var \SquareConnect\Model\V1Money
     */
    private $net_total_money;
    /**
     * $refunded_money The total of all refunds applied to the payment.
     * @var \SquareConnect\Model\V1Money
     */
    private $refunded_money;
    /**
     * $swedish_rounding_money The total of all sales, including any applicable taxes, rounded to the smallest legal
     * unit of currency (e.g., the nearest penny in USD, the nearest nickel in CAD)
     * @var \SquareConnect\Model\V1Money
     */
    private $swedish_rounding_money;
    /**
    ...
    private $tender;
    /**
     * $refunds All of the refunds applied to the payment. Note that the value of all refunds on a payment can exceed
     * the value of all tenders if a merchant chooses to refund money to a tender after previously accepting returned
    ...
    /**
     * Sets payment_url
     * @param string $payment_url The URL of the payment's detail page in the merchant dashboard. The merchant must be
     * signed in to the merchant dashboard to view this page.
     * @return $this
     */
    ...
    /**
     * Sets receipt_url
     * @param string $receipt_url The URL of the receipt for the payment. Note that for split tender payments, this URL
     * corresponds to the receipt for the first tender listed in the payment's tender field. Each Tender object has its
     * own receipt_url field you can use to get the other receipts associated with a split tender payment.
     * @return $this
     */
     ...
     * @param \SquareConnect\Model\V1Money $inclusive_tax_money The sum of all inclusive taxes associated with the
     * payment.
     * @return $this
     */
     ...
     * @param \SquareConnect\Model\V1Money $additive_tax_money The sum of all additive taxes associated with the
     * payment.
     * @return $this
     */
    ...
    /**
     * Sets tax_money
     * @param \SquareConnect\Model\V1Money $tax_money The total of all taxes applied to the payment. This is always
     * the sum of inclusive_tax_money and additive_tax_money.
     * @return $this
     */
     ...
     * @param \SquareConnect\Model\V1Money $processing_fee_money The total of all processing fees collected by Square
     * for the payment.
     * @return $this
     */
     ...
     * @param \SquareConnect\Model\V1Money $net_total_money The amount to be deposited into the merchant's bank account
     * for the payment.
     * @return $this
     */
     ...
     * @param \SquareConnect\Model\V1Money $swedish_rounding_money The total of all sales, including any applicable
     * taxes, rounded to the smallest legal unit of currency (e.g., the nearest penny in USD, the nearest nickel in CAD)
     * @return $this
     */
    ...
    /**
     * Sets refunds
     * @param \SquareConnect\Model\V1Refund[] $refunds All of the refunds applied to the payment. Note that the value
     * of all refunds on a payment can exceed the value of all tenders if a merchant chooses to refund money to a
     * tender after previously accepting returned goods as part of an exchange.
     * @return $this
     */
