...
class UpdateItemModifierListsRequest implements ArrayAccess
{
    ...
    /**
     * $item_ids The [CatalogItem](#type-catalogitem)s whose [CatalogModifierList](#type-catalogmodifierlist)s are
     * being updated.
     * @var string[]
     */
    private $item_ids;
    /**
     * $modifier_lists_to_enable The set of [CatalogModifierList](#type-catalogmodifierlist)s (referenced by ID) to
     * enable for the [CatalogItem](#type-catalogitem).
     * @var string[]
     */
    private $modifier_lists_to_enable;
    /**
     * $modifier_lists_to_disable The set of [CatalogModifierList](#type-catalogmodifierlist)s (referenced by ID) to
     * disable for the [CatalogItem](#type-catalogitem).
     * @var string[]
     */
    private $modifier_lists_to_disable;
    ...
    /**
     * Sets item_ids
     * @param string[] $item_ids The [CatalogItem](#type-catalogitem)s whose
     ...
     * @param string[] $modifier_lists_to_enable The set of [CatalogModifierList](#type-catalogmodifierlist)s
     * (referenced by ID) to enable for the [CatalogItem](#type-catalogitem).
     * @return $this
     */
     ...
     * @param string[] $modifier_lists_to_disable The set of [CatalogModifierList](#type-catalogmodifierlist)s
     * (referenced by ID) to disable for the [CatalogItem](#type-catalogitem).
     * @return $this
     */
