...
class BatchRetrieveCatalogObjectsRequest implements ArrayAccess
{
     ...
     * requested objects, as follows:  If the `objects` field of the response contains a
     * [CatalogItem](#type-catalogitem), its associated [CatalogCategory](#type-catalogcategory),
     * [CatalogTax](#type-catalogtax)es, and [CatalogModifierList](#type-catalogmodifierlist)s will be returned
     * in the `related_objects` field of the response. If the `objects` field of the response contains a
     * [CatalogItemVariation](#type-catalogitemvariation), its parent [CatalogItem](#type-catalogitem)
     ...
     * to the requested objects, as follows:  If the `objects` field of the response contains a
     * [CatalogItem](#type-catalogitem), its associated [CatalogCategory](#type-catalogcategory),
     * [CatalogTax](#type-catalogtax)es, and [CatalogModifierList](#type-catalogmodifierlist)s will be returned
     * in the `related_objects` field of the response. If the `objects` field of the response contains a
     * [CatalogItemVariation](#type-catalogitemvariation), its parent [CatalogItem](#type-catalogitem)
