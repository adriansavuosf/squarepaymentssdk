...
class V1CashDrawerEvent implements ArrayAccess
{
    ...
    public static $swaggerTypes = [
        ...
        'employee_id' => 'string',
        'event_type' => 'string',
        'event_money' => \SquareConnect\Model\V1Money::class,
        'created_at' => 'string',
        'description' => 'string'
    ];
    ...
    private $event_type;
    /**
     * $event_money The amount of money that was added to or removed from the cash drawer because of the event.
    ...
    /**
     * Sets event_money
     * @param \SquareConnect\Model\V1Money $event_money The amount of money that was added to or removed from the cash
     * drawer because of the event. This value can be positive (for added money) or negative (for removed money).
     * @return $this
     */
