...
class V1PaymentItemization implements ArrayAccess
{
    ...
    public static $swaggerTypes = [
        ...
        'item_detail' => \SquareConnect\Model\V1PaymentItemDetail::class,
        'notes' => 'string',
        'item_variation_name' => 'string',
        'total_money' => \SquareConnect\Model\V1Money::class,
        'single_quantity_money' => \SquareConnect\Model\V1Money::class,
     ...
     * @var string
     */
    private $itemization_type;
    /**
     * $item_detail Details of the item, including its unique identifier and the identifier of the item variation
     * purchased.
     ...
     * @param string $itemization_type The type of purchase that the itemization represents, such as an ITEM or
     * CUSTOM_AMOUNT
     * @return $this
     */
    ...
    /**
     * Sets item_detail
     * @param \SquareConnect\Model\V1PaymentItemDetail $item_detail Details of the item, including its unique
     * identifier and the identifier of the item variation purchased.
     * @return $this
     */
     ...
     * @param \SquareConnect\Model\V1Money $gross_sales_money The total cost of the itemization and its modifiers,
    ...
    /**
     * Sets discount_money
     * @param \SquareConnect\Model\V1Money $discount_money The total of all discounts applied to the itemization.
