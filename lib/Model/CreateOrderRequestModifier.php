...
class CreateOrderRequestModifier implements ArrayAccess
{
    ...
    /**
     * $name Only used for ad hoc modifiers. The name of the modifier. `name` cannot exceed 255 characters.
     * Do not provide a value for `name` if you provide a value for `catalog_object_id`.
     * @var string
     */
    private $name;
    /**
     * $base_price_money Only used for ad hoc modifiers. The base price for the modifier.
     * Do not provide a value for `base_price_money` if you provide a value for `catalog_object_id`.
    ...
    /**
     * Sets name
     * @param string $name Only used for ad hoc modifiers. The name of the modifier. `name` cannot exceed 255
     * characters.  Do not provide a value for `name` if you provide a value for `catalog_object_id`.
     * @return $this
     */
     ...
     * @param \SquareConnect\Model\Money $base_price_money Only used for ad hoc modifiers. The base price for the
     * modifier.  Do not provide a value for `base_price_money` if you provide a value for `catalog_object_id`.
     * @return $this
     */
