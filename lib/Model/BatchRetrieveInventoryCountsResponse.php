...
class BatchRetrieveInventoryCountsResponse implements ArrayAccess
{
    ...
    private $errors;
    /**
     * $counts The current calculated inventory counts for the requested object(s) and location(s).
    ...
    /**
     * Sets counts
     * @param \SquareConnect\Model\InventoryCount[] $counts The current calculated inventory counts for the
     * requested object(s) and location(s).
     * @return $this
     */
