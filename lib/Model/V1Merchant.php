...
class V1Merchant implements ArrayAccess
{
    ...
    public static $swaggerTypes = [
        ...
        'business_address' => \SquareConnect\Model\Address::class,
        'business_phone' => \SquareConnect\Model\V1PhoneNumber::class,
        'business_type' => 'string',
        'shipping_address_' => \SquareConnect\Model\Address::class,
        'location_details' => \SquareConnect\Model\V1MerchantLocationDetails::class,
        'market_url' => 'string'
    ];
    ...
    private $email;
    /**
     * $account_type Indicates whether the merchant account corresponds to a single-location account (LOCATION) or a
     * business account (BUSINESS). This value is almost always LOCATION.
     * @var string
     */
    private $account_type;
    /**
     * $account_capabilities Capabilities that are enabled for the merchant's Square account. Capabilities that are not
     * listed in this array are not enabled for the account.
     * @var string[]
     */
    private $account_capabilities;
    /**
    ...
    /**
     * $currency_code The currency associated with the merchant account, in ISO 4217 format. For example, the currency
    ...
    /**
     * Sets account_type
     * @param string $account_type Indicates whether the merchant account corresponds to a single-location account
     * (LOCATION) or a business account (BUSINESS). This value is almost always LOCATION.
     * @return $this
     */
     ...
     * @param string[] $account_capabilities Capabilities that are enabled for the merchant's Square account.
    ...
    /**
     * Sets currency_code
     * @param string $currency_code The currency associated with the merchant account, in ISO 4217 format.
