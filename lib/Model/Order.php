...
class Order implements ArrayAccess
{
    ...
    /**
     * $id The order's unique ID.  This value is only present for Order objects created by the Orders
     * API through the [CreateOrder](#endpoint-createorder) endpoint.
     * @var string
     */
    private $id;
    /**
    ...
    /**
     * Sets id
     * @param string $id The order's unique ID.  This value is only present for Order objects created by the Orders
     * API through the [CreateOrder](#endpoint-createorder) endpoint.
     * @return $this
     */
    ...
    /**
     * Sets reference_id
     * @param string $reference_id A client specified identifier to associate an entity in another system with this
     * order.
     * @return $this
     */
