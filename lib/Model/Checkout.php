...
class Checkout implements ArrayAccess
{
    ...
    public static $swaggerTypes = [
        ...
        'redirect_url' => 'string',
        'order' => \SquareConnect\Model\Order::class,
        'created_at' => 'string',
     ...
     * will display the primary email address associated with the merchant's Square account.  Default: none; only
     * exists if explicitly set.
     * @var string
     */
     ...
     * and finalize the order through your existing/normal confirmation workflow.
     * @var string
     */
    ...
    private $created_at;
    /**
     * $additional_recipients Additional recipients (other than the merchant) receiving a portion of this checkout.
     ...
     * @param string $checkout_page_url The URL that the buyer's browser should be redirected to after the checkout is
     * completed.
     * @return $this
     */
     ...
     * @param string $merchant_support_email The email address to display on the Square Checkout confirmation page and
     * confirmation email that the buyer can use to contact the merchant.  If this value is not set, the confirmation
     * page and email will display the primary email address associated with the merchant's Square account.
     ...
     * @param \SquareConnect\Model\AdditionalRecipient[] $additional_recipients Additional recipients (other than the
     * merchant) receiving a portion of this checkout. For example, fees assessed on the purchase by a third party
     * integration.
     * @return $this
     */
