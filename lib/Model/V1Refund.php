...
class V1Refund implements ArrayAccess
{
    ...
    /**
     * $payment_id A Square-issued ID associated with the refund. For single-tender refunds, payment_id is the ID of
     * the original payment ID. For split-tender refunds, payment_id is the ID of the original tender. For
     * exchange-based refunds (is_exchange == true), payment_id is the ID of the original payment ID even if the
     * payment includes other tenders.
     * @var string
     */
    private $payment_id;
    /**
    ...
    private $merchant_id;
    /**
     * $is_exchange Indicates whether or not the refund is associated with an exchange.
     * If is_exchange is true, the refund reflects the value of goods returned in the exchange not the total money
     * refunded.
     * @var bool
     */
    private $is_exchange;
    ...
    /**
     * Sets created_at
     * @param string $created_at The time when the merchant initiated the refund for Square to process,
     * in ISO 8601 format.
     * @return $this
     */
    ...
    /**
     * Sets processed_at
     * @param string $processed_at The time when Square processed the refund on behalf of the merchant,
     * in ISO 8601 format.
     * @return $this
     */
    ...
    /**
     * Sets payment_id
     * @param string $payment_id A Square-issued ID associated with the refund. For single-tender refunds,
     * payment_id is the ID of the original payment ID. For split-tender refunds, payment_id is the ID of the original
     * tender. For exchange-based refunds (is_exchange == true), payment_id is the ID of the original payment ID even
    ...
    /**
     * Sets is_exchange
     * @param bool $is_exchange Indicates whether or not the refund is associated with an exchange. If is_exchange is
     * true, the refund reflects the value of goods returned in the exchange not the total money refunded.
     * @return $this
     */
