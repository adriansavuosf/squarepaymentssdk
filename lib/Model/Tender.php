...
class Tender implements ArrayAccess
{
    ...
    public static $swaggerTypes = [
        ...
        'tip_money' => \SquareConnect\Model\Money::class,
        'processing_fee_money' => \SquareConnect\Model\Money::class,
        'customer_id' => 'string',
        'type' => 'string',
        'card_details' => \SquareConnect\Model\TenderCardDetails::class,
        'cash_details' => \SquareConnect\Model\TenderCashDetails::class,
    ...
    /**
     * $customer_id If the tender is associated with a customer or represents a customer's card on file, this is the
     ...
     */
    private $cash_details;
    /**
     * $additional_recipients Additional recipients (other than the merchant) receiving a portion of this tender.
     ...
     * @param \SquareConnect\Model\Money $processing_fee_money The amount of any Square processing fees applied to the
     * tender.  This field is not immediately populated when a new transaction is created. It is usually available
    ...
    /**
     * Sets customer_id
     * @param string $customer_id If the tender is associated with a customer or represents a customer's card on file,
     ...
     * @param \SquareConnect\Model\AdditionalRecipient[] $additional_recipients Additional recipients
     * (other than the merchant) receiving a portion of this tender. For example, fees assessed on the purchase by a
