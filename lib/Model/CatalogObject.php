...
class CatalogObject implements ArrayAccess
{
    ...
    public static $swaggerTypes = [
        ...
        'item_data' => \SquareConnect\Model\CatalogItem::class,
        'category_data' => \SquareConnect\Model\CatalogCategory::class,
        'item_variation_data' => \SquareConnect\Model\CatalogItemVariation::class,
        'tax_data' => \SquareConnect\Model\CatalogTax::class,
        'discount_data' => \SquareConnect\Model\CatalogDiscount::class,
        'modifier_list_data' => \SquareConnect\Model\CatalogModifierList::class,
        'modifier_data' => \SquareConnect\Model\CatalogModifier::class
    ];
    ...
    /**
     * $type The type of this object. Each object type has expected properties expressed in a structured format
     * within its corresponding `*_data` field below.
     * See [CatalogObjectType](#type-catalogobjecttype) for all possible values.
     * @var string
     */
    private $type;
    /**
     * $id An identifier to reference this object in the catalog. When a new CatalogObject is inserted,
     * the client should set the id to a temporary identifier starting with a `'#'` character.
     * Other objects being inserted or updated within the same request may use this identifier to refer
     * to the new object.  When the server receives the new object, it will supply a unique identifier that replaces
     * the temporary identifier for all future references.
     * @var string
     */
    private $id;
    /**
     * $updated_at Last modification [timestamp](#workingwithdates) in RFC 3339 format,
     * e.g., `\"2016-08-15T23:59:33.123Z\"` would indicate the UTC time (denoted by `Z`) of August 15,
     * 2016 at 23:59:33 and 123 milliseconds.
     * @var string
     */
    private $updated_at;
    /**
     * $version The version of the object. When updating an object, the version supplied by the must match the
     * version in the database, otherwise the write will be rejected as conflicting.
     * @var int
     */
    private $version;
    /**
     * $is_deleted If `true`, the object has been deleted from the database. Must be `false` for new objects being
     * inserted. When deleted, the `updated_at` field will equal the deletion time.
     * @var bool
     */
    private $is_deleted;
    /**
     * $catalog_v1_ids The Connect V1 IDs for this object at each [location](#type-location) where it is present,
     * where they differ from the object's Connect V2 ID. The field will only be present for objects that have been
     * created or modified by legacy APIs.
     * @var \SquareConnect\Model\CatalogV1Id[]
     */
    private $catalog_v1_ids;
    /**
     * $present_at_all_locations If `true`, this object is present at all locations (including future locations),
     * except where specified in the `absent_at_location_ids` field. If `false`, this object is not present at any
     * locations (including future locations), except where specified in the `present_at_location_ids` field.
     * If not specified, defaults to `true`.
     * @var bool
     */
    private $present_at_all_locations;
    /**
     * $present_at_location_ids A list of locations where the object is present, even if `present_at_all_locations`
     * is `false`.
     * @var string[]
     */
    private $present_at_location_ids;
    /**
     * $absent_at_location_ids A list of locations where the object is not present, even if `present_at_all_locations`
     * is `true`.
     * @var string[]
     */
    private $absent_at_location_ids;
    /**
    ...
    private $item_data;
    /**
     * $category_data Structured data for a [CatalogCategory](#type-catalogcategory), set for CatalogObjects of type
     * `CATEGORY`.
     * @var \SquareConnect\Model\CatalogCategory
     */
    private $category_data;
    /**
     * $item_variation_data Structured data for a [CatalogItemVariation](#type-catalogitemvariation),
     * set for CatalogObjects of type `ITEM_VARIATION`.
     * @var \SquareConnect\Model\CatalogItemVariation
     */
    private $item_variation_data;
    /**
    ...
    private $tax_data;
    /**
     * $discount_data Structured data for a [CatalogDiscount](#type-catalogdiscount), set for CatalogObjects of type
     * `DISCOUNT`.
     * @var \SquareConnect\Model\CatalogDiscount
     */
    private $discount_data;
    /**
     * $modifier_list_data Structured data for a [CatalogModifierList](#type-catalogmodifierlist),
     * set for CatalogObjects of type `MODIFIER_LIST`.
     * @var \SquareConnect\Model\CatalogModifierList
     */
    private $modifier_list_data;
    /**
     * $modifier_data Structured data for a [CatalogModifier](#type-catalogmodifier),
     * set for CatalogObjects of type `MODIFIER`.
     * @var \SquareConnect\Model\CatalogModifier
     */
    private $modifier_data;
    ...
    /**
     * Sets type
     * @param string $type The type of this object. Each object type has expected properties expressed in a structured
    ...
    /**
     * Sets id
     * @param string $id An identifier to reference this object in the catalog. When a new CatalogObject is inserted,
     * the client should set the id to a temporary identifier starting with a `'#'` character.
     * Other objects being inserted or updated within the same request may use this identifier to refer
     * to the new object.  When the server receives the new object, it will supply a unique identifier that replaces
     * the temporary identifier for all future references.
    ...
    /**
     * Sets updated_at
     * @param string $updated_at Last modification [timestamp](#workingwithdates) in RFC 3339 format,
     * e.g., `\"2016-08-15T23:59:33.123Z\"` would indicate the UTC time (denoted by `Z`) of August 15,
     * 2016 at 23:59:33 and 123 milliseconds.
     * @return $this
     */
    ...
    /**
     * Sets version
     * @param int $version The version of the object. When updating an object, the version supplied by the must match
     * the version in the database, otherwise the write will be rejected as conflicting.
     * @return $this
     */
    ...
    /**
     * Sets is_deleted
     * @param bool $is_deleted If `true`, the object has been deleted from the database. Must be `false`
     * for new objects being inserted. When deleted, the `updated_at` field will equal the deletion time.
     * @return $this
     */
    ...
    /**
     * Sets catalog_v1_ids
     * @param \SquareConnect\Model\CatalogV1Id[] $catalog_v1_ids The Connect V1 IDs for this object at each
     * [location](#type-location) where it is present, where they differ from the object's Connect V2 ID.
     ...
     * @param bool $present_at_all_locations If `true`, this object is present at all locations
     * (including future locations), except where specified in the `absent_at_location_ids` field. If `false`,
     * this object is not present at any locations (including future locations), except where specified in the
     ...
     * @param string[] $present_at_location_ids A list of locations where the object is present, even if
     ...
     * @param string[] $absent_at_location_ids A list of locations where the object is not present,
     * even if `present_at_all_locations` is `true`.
     * @return $this
     */
    ...
    /**
     * Sets item_data
     * @param \SquareConnect\Model\CatalogItem $item_data Structured data for a [CatalogItem](#type-catalogitem),
     * set for CatalogObjects of type `ITEM`.
     * @return $this
     */
    ...
    /**
     * Sets category_data
     * @param \SquareConnect\Model\CatalogCategory $category_data Structured data for a
     * [CatalogCategory](#type-catalogcategory), set for CatalogObjects of type `CATEGORY`.
     * @return $this
     */
     ...
     * @param \SquareConnect\Model\CatalogItemVariation $item_variation_data Structured data for a
     * [CatalogItemVariation](#type-catalogitemvariation), set for CatalogObjects of type `ITEM_VARIATION`.
     * @return $this
     */
    ...
    /**
     * Sets tax_data
     * @param \SquareConnect\Model\CatalogTax $tax_data Structured data for a [CatalogTax](#type-catalogtax),
     * set for CatalogObjects of type `TAX`.
     * @return $this
     */
    ...
    /**
     * Sets discount_data
     * @param \SquareConnect\Model\CatalogDiscount $discount_data Structured data for a
     * [CatalogDiscount](#type-catalogdiscount), set for CatalogObjects of type `DISCOUNT`.
     * @return $this
     */
     ...
     * @param \SquareConnect\Model\CatalogModifierList $modifier_list_data Structured data for a
     * [CatalogModifierList](#type-catalogmodifierlist), set for CatalogObjects of type `MODIFIER_LIST`.
     * @return $this
     */
    ...
    /**
     * Sets modifier_data
     * @param \SquareConnect\Model\CatalogModifier $modifier_data Structured data for a
     * [CatalogModifier](#type-catalogmodifier), set for CatalogObjects of type `MODIFIER`.
     * @return $this
     */
