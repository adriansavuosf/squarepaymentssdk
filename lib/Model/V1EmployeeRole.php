...
class V1EmployeeRole implements ArrayAccess
{
    ...
    private $permissions;
    /**
     * $is_owner If true, employees with this role have all permissions, regardless of the values indicated in
     * permissions.
     * @var bool
     */
    private $is_owner;
    /**
     * $created_at The time when the employee entity was created, in ISO 8601 format. Is set by Square when the Role
     * is created.
     * @var string
     */
    private $created_at;
    /**
     * $updated_at The time when the employee entity was most recently updated, in ISO 8601 format. Is set by Square
    ...
    /**
     * Sets is_owner
     * @param bool $is_owner If true, employees with this role have all permissions, regardless of the values indicated
     * in permissions.
     * @return $this
     */
    ...
    /**
     * Sets created_at
     * @param string $created_at The time when the employee entity was created, in ISO 8601 format. Is set by Square
