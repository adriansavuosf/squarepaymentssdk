...
class Refund implements ArrayAccess
{
    ...
    /**
     * $additional_recipients Additional recipients (other than the merchant) receiving a portion of this refund.
     ...
     * @param \SquareConnect\Model\Money $processing_fee_money The amount of Square processing fee money refunded to
     * the *merchant*.
     * @return $this
     */
     ...
     * (other than the merchant) receiving a portion of this refund.
     * For example, fees assessed on a refund of a purchase by a third party integration.
     * @return $this
     */
