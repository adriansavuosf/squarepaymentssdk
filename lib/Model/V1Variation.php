...
class V1Variation implements ArrayAccess
{
    ...
    public static $swaggerTypes = [
        ...
        'ordinal' => 'int',
        'pricing_type' => 'string',
        'price_money' => \SquareConnect\Model\V1Money::class,
        'sku' => 'string',
    ...
    private $item_id;
    /**
     * $ordinal Indicates the variation's list position when displayed in Square Register and the merchant dashboard.
    ...
    /**
     * $inventory_alert_type Indicates whether the item variation displays an alert when its inventory quantity is less
    ...
    /**
     * Sets ordinal
     * @param int $ordinal Indicates the variation's list position when displayed in Square Register and the merchant
     * dashboard. If more than one variation for the same item has the same ordinal value, those variations are
    ...
    /**
     * Sets pricing_type
     * @param string $pricing_type Indicates whether the item variation's price is fixed or determined at the time of
     * sale.
     * @return $this
     */
