...
class CatalogQueryItemsForTax implements ArrayAccess
{
    ...
    /**
     * $tax_ids A set of [CatalogTax](#type-catalogtax) IDs to be used to find associated
    ...
    /**
     * Sets tax_ids
     * @param string[] $tax_ids A set of [CatalogTax](#type-catalogtax) IDs to be used to find associated
     * [CatalogItem](#type-catalogitem)s.
     * @return $this
     */
