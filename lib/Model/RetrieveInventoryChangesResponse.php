...
class RetrieveInventoryChangesResponse implements ArrayAccess
{
    ...
    private $errors;
    /**
     * $changes The set of inventory changes for the requested object and location(s).
    ...
    /**
     * Sets changes
     * @param \SquareConnect\Model\InventoryChange[] $changes The set of inventory changes for the requested object
     * and location(s).
     * @return $this
     */
