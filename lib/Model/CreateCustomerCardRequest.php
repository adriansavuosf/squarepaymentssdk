...
class CreateCustomerCardRequest implements ArrayAccess
{
    ...
    /**
     * $card_nonce A card nonce representing the credit card to link to the customer.  Card nonces are generated by the
     * `SqPaymentForm` that buyers enter their card information into.
     * See [Embedding the payment form](/articles/adding-payment-form/) for more information.
     * __Note:__ Card nonces generated by digital wallets (e.g., Apple Pay) cannot be used to create a customer card.
     * @var string
     */
    private $card_nonce;
    /**
    ...
    /**
     * Sets card_nonce
     * @param string $card_nonce A card nonce representing the credit card to link to the customer.  Card nonces are
     * generated by the `SqPaymentForm` that buyers enter their card information into.
     * See [Embedding the payment form](/articles/adding-payment-form/) for more information.
     * __Note:__ Card nonces generated by digital wallets (e.g., Apple Pay) cannot be used to create a customer card.
     * @return $this
     */
     ...
     * @param \SquareConnect\Model\Address $billing_address Address information for the card on file. Only the
     * `postal_code` field is required for payments in the US and Canada.
     * @return $this
     */
