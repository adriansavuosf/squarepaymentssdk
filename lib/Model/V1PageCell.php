...
class V1PageCell implements ArrayAccess
{
    ...
    private $object_type;
    /**
     * $object_id The unique identifier of the entity represented in the cell. Not present for cells with an
     * object_type of PLACEHOLDER.
     * @var string
     */
    private $object_id;
    /**
     * $placeholder_type For a cell with an object_type of PLACEHOLDER, this value indicates the cell's special
     * behavior.
     * @var string
     */
    ...
    /**
     * Sets object_id
     * @param string $object_id The unique identifier of the entity represented in the cell. Not present for cells with
     ...
     * @param string $placeholder_type For a cell with an object_type of PLACEHOLDER, this value indicates the cell's
     * special behavior.
     * @return $this
     */
