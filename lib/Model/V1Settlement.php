...
class V1Settlement implements ArrayAccess
{
    ...
    private $status;
    /**
     * $total_money The amount of money involved in the settlement. A positive amount indicates a deposit, and a
     * negative amount indicates a withdrawal. This amount is never zero.
    ...
    /**
     * Sets total_money
     * @param \SquareConnect\Model\V1Money $total_money The amount of money involved in the settlement.
    ...
    /**
     * Sets initiated_at
     * @param string $initiated_at The time when the settlement was submitted for deposit or withdrawal,
     * in ISO 8601 format.
     * @return $this
     */
     ...
     * @param string $bank_account_id The Square-issued unique identifier for the bank account associated with the
     * settlement.
     * @return $this
     */
