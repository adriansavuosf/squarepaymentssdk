...
class V1PaymentModifier implements ArrayAccess
{
    ...
    /**
     * $modifier_option_id TThe ID of the applied modifier option, if available. Modifier options applied in older
     * versions of Square Register might not have an ID.
     * @var string
     */
    private $modifier_option_id;
    ...
    /**
     * Sets applied_money
     * @param \SquareConnect\Model\V1Money $applied_money The amount of money that this modifier option adds to the
     * payment.
     * @return $this
     */
     ...
     * @param string $modifier_option_id TThe ID of the applied modifier option, if available. Modifier options applied
