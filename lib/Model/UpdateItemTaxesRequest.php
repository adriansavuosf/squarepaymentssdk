...
class UpdateItemTaxesRequest implements ArrayAccess
{
    ...
    /**
     * $item_ids The [CatalogItem](#type-catalogitem)s whose enabled/disabled [CatalogTax](#type-catalogtax)es are
     * being updated.
     * @var string[]
     */
    private $item_ids;
    /**
     * $taxes_to_enable The set of [CatalogTax](#type-catalogtax)es (referenced by ID) to enable for the
     * [CatalogItem](#type-catalogitem).
     * @var string[]
     */
    private $taxes_to_enable;
    /**
     * $taxes_to_disable The set of [CatalogTax](#type-catalogtax)es (referenced by ID) to disable for the
     * [CatalogItem](#type-catalogitem).
     * @var string[]
     */
    private $taxes_to_disable;
    ...
    /**
     * Sets item_ids
     * @param string[] $item_ids The [CatalogItem](#type-catalogitem)s whose enabled/disabled
     ...
     * @param string[] $taxes_to_enable The set of [CatalogTax](#type-catalogtax)es (referenced by ID) to enable for
     * the [CatalogItem](#type-catalogitem).
     * @return $this
     */
     ...
     * @param string[] $taxes_to_disable The set of [CatalogTax](#type-catalogtax)es (referenced by ID) to disable for
     * the [CatalogItem](#type-catalogitem).
     * @return $this
     */
