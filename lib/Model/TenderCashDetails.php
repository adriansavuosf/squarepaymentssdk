...
class TenderCashDetails implements ArrayAccess
{
    ...
    public static $swaggerTypes = [
        'buyer_tendered_money' => \SquareConnect\Model\Money::class,
        'change_back_money' => \SquareConnect\Model\Money::class
    ];
     ...
     * @param \SquareConnect\Model\Money $buyer_tendered_money The total amount of cash provided by the buyer,
     * before change is given.
     * @return $this
     */
