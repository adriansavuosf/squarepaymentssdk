...
class V1BankAccount implements ArrayAccess
{
     ...
     * @var string
     */
    private $account_number_suffix;
    /**
     * $currency_code The currency code of the currency associated with the bank account, in ISO 4217 format.
    ...
    /**
     * Sets currency_code
     * @param string $currency_code The currency code of the currency associated with the bank account, in ISO 4217
