...
class Card implements ArrayAccess
{
    ...
    /**
     * $fingerprint The unique string fingerprint for the card.
     ...
     * See [CardBrand](#type-cardbrand) for all possible values.
     * @return $this
     */
    ...
    /**
     * Sets exp_month
     * @param int $exp_month The month of the card's expiration date.
     ...
     * @param \SquareConnect\Model\Address $billing_address The card's billing address.
     * This value is present only if this object represents a customer's card on file.
     * @return $this
     */
    ...
    /**
     * Sets fingerprint
     * @param string $fingerprint The unique string fingerprint for the card.
     * The fingerprint is based on the credit card number and is unique to the merchant.
     * If a card is used at multiple locations for the same merchant, it will have the same fingerprint in each case.
     * Note: Fingerprint may not exist on old transactions.
     * @return $this
