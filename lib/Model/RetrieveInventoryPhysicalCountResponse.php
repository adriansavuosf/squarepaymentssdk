...
class RetrieveInventoryPhysicalCountResponse implements ArrayAccess
{
    ...
    public static $swaggerTypes = [
        ...
        'count' => \SquareConnect\Model\InventoryPhysicalCount::class
    ];
    ...
    private $errors;
    /**
     * $count The [InventoryPhysicalCount](#type-inventoryphysicalcount) with the requested id.
    ...
    /**
     * Sets count
     * @param \SquareConnect\Model\InventoryPhysicalCount $count
     * The [InventoryPhysicalCount](#type-inventoryphysicalcount) with the requested id.
     * @return $this
     */
