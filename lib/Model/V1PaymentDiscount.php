...
class V1PaymentDiscount implements ArrayAccess
{
    ...
    public static $swaggerTypes = [
        'name' => 'string',
        'applied_money' => \SquareConnect\Model\V1Money::class,
        'discount_id' => 'string'
    ];
    ...
    private $name;
    /**
     * $applied_money The amount of money that this discount adds to the payment (note that this value is always
     * negative or zero).
     * @var \SquareConnect\Model\V1Money
     */
    private $applied_money;
    /**
     * $discount_id The ID of the applied discount, if available. Discounts applied in older versions of Square
    ...
    /**
     * Sets applied_money
     * @param \SquareConnect\Model\V1Money $applied_money The amount of money that this discount adds to the payment
     * (note that this value is always negative or zero).
     * @return $this
     */
    ...
    /**
     * Sets discount_id
     * @param string $discount_id The ID of the applied discount, if available. Discounts applied in older versions
