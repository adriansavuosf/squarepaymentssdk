...
class CatalogModifierOverride implements ArrayAccess
{
    ...
    private $modifier_id;
    /**
     * $on_by_default If `true`, this [CatalogModifier](#type-catalogmodifier) should be selected by default for this
    ...
    /**
     * Sets modifier_id
     * @param string $modifier_id The ID of the [CatalogModifier](#type-catalogmodifier) whose default behavior is
     * being overridden.
     * @return $this
     */
    ...
    /**
     * Sets on_by_default
     * @param bool $on_by_default If `true`, this [CatalogModifier](#type-catalogmodifier) should be selected
     * by default for this [CatalogItem](#type-catalogitem).
     * @return $this
     */
