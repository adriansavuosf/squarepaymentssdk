...
class TenderCardDetails implements ArrayAccess
{
    ...
    /**
     * $status The credit card payment's current state (such as `AUTHORIZED` or `CAPTURED`).
    ...
    /**
     * Sets status
     * @param string $status The credit card payment's current state (such as `AUTHORIZED` or `CAPTURED`).
     * See [TenderCardDetailsStatus](#type-tendercarddetailsstatus) for possible values.
     * @return $this
     */
