...
class V1ModifierOption implements ArrayAccess
{
    ...
    private $price_money;
    /**
     * $on_by_default If true, the modifier option is the default option in a modifier list for which selection_type is
     * SINGLE.
     * @var bool
     */
    private $on_by_default;
    /**
     * $ordinal Indicates the modifier option's list position when displayed in Square Register and the merchant
     * dashboard. If more than one modifier option in the same modifier list has the same ordinal value, those options
    ...
    /**
     * Sets on_by_default
     * @param bool $on_by_default If true, the modifier option is the default option in a modifier list for which
    ...
    /**
     * Sets ordinal
     * @param int $ordinal Indicates the modifier option's list position when displayed in Square Register and the
     * merchant dashboard. If more than one modifier option in the same modifier list has the same ordinal value, those
