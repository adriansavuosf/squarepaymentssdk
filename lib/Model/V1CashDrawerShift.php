...
class V1CashDrawerShift implements ArrayAccess
{
    ...
    public static $swaggerTypes = [
        ...
        'description' => 'string',
        'starting_cash_money' => \SquareConnect\Model\V1Money::class,
        'cash_payment_money' => \SquareConnect\Model\V1Money::class,
        'cash_refunds_money' => \SquareConnect\Model\V1Money::class,
        'cash_paid_in_money' => \SquareConnect\Model\V1Money::class,
        'cash_paid_out_money' => \SquareConnect\Model\V1Money::class,
        'expected_cash_money' => \SquareConnect\Model\V1Money::class,
        'closed_cash_money' => \SquareConnect\Model\V1Money::class,
    ...
    private $closed_at;
    /**
     * $employee_ids The IDs of all employees that were logged into Square Register at some point during the cash drawer
     * shift.
     * @var string[]
     */
     ...
     * @var string
     */
    private $opening_employee_id;
    /**
     * $ending_employee_id The ID of the employee that ended the cash drawer shift.
     * @var string
     */
    private $ending_employee_id;
    /**
     * $closing_employee_id The ID of the employee that closed the cash drawer shift by auditing the cash drawer's
     * contents.
     * @var string
     */
    private $closing_employee_id;
    /**
    ...
    /**
     * Sets employee_ids
     * @param string[] $employee_ids The IDs of all employees that were logged into Square Register at some point during
     * the cash drawer shift.
     * @return $this
     */
     ...
     * @param string $closing_employee_id The ID of the employee that closed the cash drawer shift by auditing the cash
     * drawer's contents.
     * @return $this
     */
     ...
     * @param \SquareConnect\Model\V1Money $starting_cash_money The amount of money in the cash drawer at the start of
     * the shift.
     * @return $this
     */
     ...
     * @param \SquareConnect\Model\V1Money $cash_payment_money The amount of money added to the cash drawer from cash
     * payments.
     * @return $this
     */
     ...
     * @param \SquareConnect\Model\V1Money $cash_refunds_money The amount of money removed from the cash drawer from
     * cash refunds. This value is always negative or zero.
     * @return $this
     */
     ...
     * @param \SquareConnect\Model\V1Money $cash_paid_in_money The amount of money added to the cash drawer for reasons
     ...
     * @param \SquareConnect\Model\V1Money $cash_paid_out_money The amount of money removed from the cash drawer for
     * reasons other than cash refunds.
     * @return $this
     */
     ...
     * @param \SquareConnect\Model\V1Money $expected_cash_money The amount of money that should be in the cash drawer
     * at the end of the shift, based on the shift's other money amounts.
     * @return $this
     */
     ...
     * @param \SquareConnect\Model\V1Money $closed_cash_money The amount of money found in the cash drawer at the end
     * of the shift by an auditing employee.
     * @return $this
     */
    ...
    /**
     * Sets device
     * @param \SquareConnect\Model\Device $device The device running Square Register that was connected to the cash
     * drawer.
     * @return $this
     */
    ...
    /**
     * Sets events
     * @param \SquareConnect\Model\V1CashDrawerEvent[] $events All of the events (payments, refunds, and so on) that
     * involved the cash drawer during the shift.
     * @return $this
     */
