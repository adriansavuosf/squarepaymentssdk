...
class AdditionalRecipient implements ArrayAccess
{
    ...
    /**
     * $receivable_id The unique ID for this [AdditionalRecipientReceivable](#type-additionalrecipientreceivable),
     * assigned by the server.
     * @var string
     */
    private $receivable_id;
    ...
    /**
     * Sets location_id
     * @param string $location_id The location ID for a recipient (other than the merchant)
    ...
    /**
     * Sets receivable_id
     * @param string $receivable_id The unique ID for this
     * [AdditionalRecipientReceivable](#type-additionalrecipientreceivable), assigned by the server.
     * @return $this
     */
