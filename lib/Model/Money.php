...
class Money implements ArrayAccess
{
    ...
    private $amount;
    /**
     * $currency The type of currency, in __ISO 4217 format__. For example, the currency code for US dollars is `USD`.
    ...
    /**
     * Sets amount
     * @param int $amount The amount of money, in the smallest denomination of the currency indicated by `currency`.
     * For example, when `currency` is `USD`, `amount` is in cents.
     * @return $this
     */
    ...
    /**
     * Sets currency
     * @param string $currency The type of currency, in __ISO 4217 format__.
