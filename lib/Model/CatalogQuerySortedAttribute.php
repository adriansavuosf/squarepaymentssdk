...
class CatalogQuerySortedAttribute implements ArrayAccess
{
    ...
    /**
     * $initial_attribute_value The first attribute value to be returned by the query.
     * Ascending sorts will return only objects with this value or greater, while descending sorts will return only
     * objects with this value or less. If unset, start at the beginning (for ascending sorts) or
     * end (for descending sorts).
     * @var string
     */
    private $initial_attribute_value;
    /**
     ...
     * @param string $initial_attribute_value The first attribute value to be returned by the query.
     * Ascending sorts will return only objects with this value or greater, while descending sorts will return only
     * objects with this value or less. If unset, start at the beginning (for ascending sorts) or
     * end (for descending sorts).
     * @return $this
    ...
    /**
     * Sets sort_order
     * @param string $sort_order The desired [SortOrder](#type-sortorder), `\"ASC\"` (ascending) or `\"DESC\"`
     * (descending).
     * @return $this
     */
