...
class ListAdditionalRecipientReceivableRefundsRequest implements ArrayAccess
{
    ...
    /**
     * $begin_time The beginning of the requested reporting period, in RFC 3339 format.  See [Date ranges](#dateranges)
     * for details on date inclusivity/exclusivity.  Default value: The current time minus one year.
     * @var string
     */
    private $begin_time;
    /**
     * $end_time The end of the requested reporting period, in RFC 3339 format.  See [Date ranges](#dateranges) for
     * details on date inclusivity/exclusivity.  Default value: The current time.
     * @var string
     */
    private $end_time;
    /**
     * $sort_order The order in which results are listed in the response (`ASC` for oldest first, `DESC` for newest
     * first).  Default value: `DESC`
     * @var string
     */
    private $sort_order;
    /**
