...
class ApplePayApi
{
     ...
     * RegisterDomain
     *
     * @param \SquareConnect\Model\RegisterDomainRequest $body An object containing the fields to POST for the request.
     ...
     * @param \SquareConnect\Model\RegisterDomainRequest $body An object containing the fields to POST for the request.
     * See the corresponding object definition for field details. (required)
     * @return array of \SquareConnect\Model\RegisterDomainResponse, HTTP status code,
    ...
    public function registerDomainWithHttpInfo($body)
    {
        ...
        if ($body === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling registerDomain'
            );
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\RegisterDomainResponse::class
            );
            if (!$response) {
