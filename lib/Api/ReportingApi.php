...
class ReportingApi
{
    ...
    public function listAdditionalRecipientReceivableRefunds(
        ...
        list($response, $statusCode, $httpHeader) = $this->listAdditionalRecipientReceivableRefundsWithHttpInfo(
            $location_id,
            $begin_time,
            $end_time,
            $sort_order,
     ...
     * Provide this to retrieve the next set of results for your original query.
     * See [Paginating results](#paginatingresults) for more information. (optional)
     * @return Array of \SquareConnect\Model\ListAdditionalRecipientReceivableRefundsResponse,
     * HTTP status code, HTTP response headers (array of strings)
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    public function listAdditionalRecipientReceivableRefundsWithHttpInfo(
        $location_id,
        $begin_time = null,
        $end_time = null,
        $sort_order = null,
        ...
        if ($location_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $location_id when calling
                listAdditionalRecipientReceivableRefunds'
            );
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\ListAdditionalRecipientReceivableRefundsResponse::class
            );
            if (!$response) {
    ...
    public function listAdditionalRecipientReceivables(
        ...
        list($response, $statusCode, $httpHeader) = $this->listAdditionalRecipientReceivablesWithHttpInfo(
            $location_id,
            $begin_time,
            $end_time,
            $sort_order,
     ...
     * Provide this to retrieve the next set of results for your original query.
     * See [Paginating results](#paginatingresults) for more information. (optional)
     * @return Array of \SquareConnect\Model\ListAdditionalRecipientReceivablesResponse, HTTP status code,
     * HTTP response headers (array of strings)
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    public function listAdditionalRecipientReceivablesWithHttpInfo(
        $location_id,
        $begin_time = null,
        $end_time = null,
        $sort_order = null,
        ...
        if ($location_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $location_id when calling listAdditionalRecipientReceivables'
            );
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\ListAdditionalRecipientReceivablesResponse::class
            );
            if (!$response) {
                return [null, $statusCode, $httpHeader];
            }
