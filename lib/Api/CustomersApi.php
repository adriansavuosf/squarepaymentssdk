...
class CustomersApi
{
     ...
     * CreateCustomer
     *
     * @param \SquareConnect\Model\CreateCustomerRequest $body An object containing the fields to POST
     * for the request.  See the corresponding object definition for field details. (required)
     ...
     * CreateCustomer
     *
     * @param \SquareConnect\Model\CreateCustomerRequest $body An object containing the fields
     * to POST for the request.  See the corresponding object definition for field details. (required)
     * @return Array of \SquareConnect\Model\CreateCustomerResponse, HTTP status code,
    ...
    public function createCustomerWithHttpInfo($body)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\CreateCustomerResponse::class
            );
            if (!$response) {
     ...
     * @param \SquareConnect\Model\CreateCustomerCardRequest $body An object containing the fields
     * to POST for the request.  See the corresponding object definition for field details. (required)
     ...
     * @param \SquareConnect\Model\CreateCustomerCardRequest $body An object containing the fields
     * to POST for the request.  See the corresponding object definition for field details. (required)
     * @return Array of \SquareConnect\Model\CreateCustomerCardResponse, HTTP status code,
     * HTTP response headers (array of strings)
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    public function createCustomerCardWithHttpInfo($customer_id, $body)
    {
        ...
        if ($customer_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $customer_id when calling createCustomerCard'
            );
        }
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling createCustomerCard'
            );
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\CreateCustomerCardResponse::class
            );
            if (!$response) {
                return [null, $statusCode, $httpHeader];
            }
     ...
     *
     * @param string $customer_id The ID of the customer to delete. (required)
     * @return Array of \SquareConnect\Model\DeleteCustomerResponse, HTTP status code,
     * HTTP response headers (array of strings)
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    public function deleteCustomerWithHttpInfo($customer_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\DeleteCustomerResponse::class
            );
            if (!$response) {
                return [null, $statusCode, $httpHeader];
            }
     ...
     * @param string $customer_id The ID of the customer that the card on file belongs to. (required)
     * @param string $card_id The ID of the card on file to delete. (required)
     * @return Array of \SquareConnect\Model\DeleteCustomerCardResponse, HTTP status code,
     * HTTP response headers (array of strings)
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    public function deleteCustomerCardWithHttpInfo($customer_id, $card_id)
    {
        ...
        if ($customer_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $customer_id when calling deleteCustomerCard'
            );
        }
        // verify the required parameter 'card_id' is set
        if ($card_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $card_id when calling deleteCustomerCard'
            );
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\DeleteCustomerCardResponse::class
            );
            if (!$response) {
                return [null, $statusCode, $httpHeader];
            }
     ...
     * Provide this to retrieve the next set of results for your original query.
     * See [Paginating results](#paginatingresults) for more information. (optional)
     * @return Array of \SquareConnect\Model\ListCustomersResponse, HTTP status code,
     * HTTP response headers (array of strings)
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    public function listCustomersWithHttpInfo($cursor = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\ListCustomersResponse::class
            );
            if (!$response) {
                return [null, $statusCode, $httpHeader];
            }
     ...
     *
     * @param string $customer_id The ID of the customer to retrieve. (required)
     * @return Array of \SquareConnect\Model\RetrieveCustomerResponse, HTTP status code,
     * HTTP response headers (array of strings)
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    public function retrieveCustomerWithHttpInfo($customer_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\RetrieveCustomerResponse::class
            );
            if (!$response) {
                return [null, $statusCode, $httpHeader];
            }
     ...
     * @param \SquareConnect\Model\UpdateCustomerRequest $body An object containing the fields to POST
     * for the request.  See the corresponding object definition for field details. (required)
     ...
     * @return Array of \SquareConnect\Model\UpdateCustomerResponse, HTTP status code,
     * HTTP response headers (array of strings)
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    public function updateCustomerWithHttpInfo($customer_id, $body)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\UpdateCustomerResponse::class
            );
            if (!$response) {
                return [null, $statusCode, $httpHeader];
            }
