...
class V1TransactionsApi
{
     ...
     * createRefund
     *
     * Issues a refund for a previously processed payment. You must issue a refund within 60 days of the
     * associated payment.
     *
     * @param string $location_id The ID of the original payment&#39;s associated location. (required)
     * @param \SquareConnect\Model\V1CreateRefundRequest $body An object containing the fields to POST for the request.
     ...
     * listBankAccounts
     *
     * Provides non-confidential details for all of a location's associated bank accounts.
     * This endpoint does not provide full bank account numbers, and there is no way to obtain a
     ...
     *
     * Provides non-confidential details for all of a location's associated bank accounts.
     * This endpoint does not provide full bank account numbers, and there is no way to obtain
     * a full bank account number with the Connect API.
     *
     * @param string $location_id The ID of the location to list bank accounts for. (required)
     * @return Array of \SquareConnect\Model\V1BankAccount[], HTTP status code,
    ...
    public function listBankAccountsWithHttpInfo($location_id)
    {
        ...
        if ($location_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $location_id when calling listBankAccounts'
            );
        }
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->listOrdersWithHttpInfo(
            $location_id,
            $order,
            $limit,
            $batch_token
    ...
    public function listOrdersWithHttpInfo($location_id, $order = null, $limit = null, $batch_token = null)
    {
        ...
        if ($location_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $location_id when calling listOrders'
            );
        }
     ...
     * listPayments
     *
     * Provides summary information for all payments taken by a merchant or any of the merchant's mobile staff
     * during a date range. Date ranges cannot exceed one year in length. See Date ranges for details of inclusive
     * and exclusive dates.
     *
     * @param string $location_id The ID of the location to list payments for. If you specify me,
     * this endpoint returns payments aggregated from all of the business&#39;s locations. (required)
     ...
     * @param string $end_time The end of the requested reporting period, in ISO 8601 format.
    ...
    public function listPayments(
        ...
        list($response, $statusCode, $httpHeader) = $this->listPaymentsWithHttpInfo(
            $location_id,
            $order,
            $begin_time,
            $end_time,
     ...
     *
     * Provides summary information for all payments taken by a merchant or any of the merchant's mobile staff during
     * a date range. Date ranges cannot exceed one year in length.
     * See Date ranges for details of inclusive and exclusive dates.
     *
     * @param string $location_id The ID of the location to list payments for.
     * If you specify me, this endpoint returns payments aggregated from all of the business&#39;s locations. (required)
     * @param string $order The order in which payments are listed in the response. (optional)
     * @param string $begin_time The beginning of the requested reporting period, in ISO 8601 format.
     * If this value is before January 1, 2013 (2013-01-01T00:00:00Z), this endpoint returns an error.
     * Default value: The current time minus one year. (optional)
     ...
     * If this value is more than one year greater than begin_time, this endpoint returns an error.
     * Default value: The current time. (optional)
     * @param int $limit The maximum number of payments to return in a single response.
     * This value cannot exceed 200. (optional)
     * @param string $batch_token A pagination cursor to retrieve the next set of results for your original query
     * to the endpoint. (optional)
    ...
    public function listPaymentsWithHttpInfo(
        ...
        if ($location_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $location_id when calling listPayments'
            );
        }
     ...
     * If this value is more than one year greater than begin_time, this endpoint returns an error.
     * Default value: The current time. (optional)
     * @param int $limit The approximate number of refunds to return in a single response.
     * Default: 100. Max: 200. Response may contain more results than the prescribed limit when
     * refunds are made simultaneously to multiple tenders in a payment or when refunds are generated in an
     * exchange to account for the value of returned goods. (optional)
     * @param string $batch_token A pagination cursor to retrieve the next set of results for your original query
     * to the endpoint. (optional)
     * @return \SquareConnect\Model\V1Refund[]
     * @throws \SquareConnect\ApiException on non-2xx response
    ...
    public function listRefunds(
        ...
        list($response, $statusCode, $httpHeader) = $this->listRefundsWithHttpInfo(
            $location_id,
            $order,
            $begin_time,
            $end_time,
     ...
     * Default value: The current time. (optional)
     * @param int $limit The approximate number of refunds to return in a single response.
     * Default: 100. Max: 200. Response may contain more results than the prescribed limit when refunds
     * are made simultaneously to multiple tenders in a payment or when refunds are generated in an
     * exchange to account for the value of returned goods. (optional)
     * @param string $batch_token A pagination cursor to retrieve the next set of results for your original query
     * to the endpoint. (optional)
     * @return Array of \SquareConnect\Model\V1Refund[], HTTP status code, HTTP response headers (array of strings)
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    public function listRefundsWithHttpInfo(
        $location_id,
        $order = null,
        $begin_time = null,
        $end_time = null,
        ...
        if ($location_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $location_id when calling listRefunds'
            );
        }
     ...
     * listSettlements
     *
     * Provides summary information for all deposits and withdrawals initiated by Square to a merchant's
     * bank account during a date range. Date ranges cannot exceed one year in length.
     *
     * @param string $location_id The ID of the location to list settlements for.
     * If you specify me, this endpoint returns payments aggregated from all of the business&#39;s locations. (required)
     * @param string $order TThe order in which payments are listed in the response. (optional)
     * @param string $begin_time The beginning of the requested reporting period, in ISO 8601 format.
     * If this value is before January 1, 2013 (2013-01-01T00:00:00Z), this endpoint returns an error.
     ...
     * @param int $limit The maximum number of payments to return in a single response.
     * This value cannot exceed 200. (optional)
     * @param string $status Provide this parameter to retrieve only settlements
     * with a particular status (SENT or FAILED). (optional)
     * @param string $batch_token A pagination cursor to retrieve the next set of results for your original query
     * to the endpoint. (optional)
    ...
    public function listSettlements(
        ...
        list($response, $statusCode, $httpHeader) = $this->listSettlementsWithHttpInfo(
            $location_id,
            $order,
            $begin_time,
            $end_time,
     ...
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    public function listSettlementsWithHttpInfo(
        $location_id,
        $order = null,
        $begin_time = null,
        $end_time = null,
        ...
        if ($location_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $location_id when calling listSettlements'
            );
        }
     ...
     * This endpoint does not provide full bank account numbers, and there is no way to obtain a full bank
     * account number with the Connect API.
     *
     * @param string $location_id The ID of the bank account&#39;s associated location. (required)
     * @param string $bank_account_id The bank account&#39;s Square-issued ID.
     * You obtain this value from Settlement objects returned. (required)
     * @return \SquareConnect\Model\V1BankAccount
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    public function retrieveBankAccount($location_id, $bank_account_id)
    {
        list($response, $statusCode, $httpHeader) = $this->retrieveBankAccountWithHttpInfo(
            $location_id,
            $bank_account_id
        );
        return $response;
     ...
     *
     * Provides non-confidential details for a merchant's associated bank account.
     * This endpoint does not provide full bank account numbers, and there is no way to obtain a full bank account
    ...
    public function retrieveBankAccountWithHttpInfo($location_id, $bank_account_id)
    {
        ...
        if ($location_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $location_id when calling retrieveBankAccount'
            );
        }
        // verify the required parameter 'bank_account_id' is set
        if ($bank_account_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $bank_account_id when calling retrieveBankAccount'
            );
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\V1BankAccount::class
            );
            if (!$response) {
                return [null, $statusCode, $httpHeader];
            }
     ...
     * @param string $order_id The order&#39;s Square-issued ID.
     * You obtain this value from Order objects returned by the List Orders endpoint (required)
     * @return \SquareConnect\Model\V1Order
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    ...
    public function retrieveOrderWithHttpInfo($location_id, $order_id)
    {
        ...
        if ($location_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $location_id when calling retrieveOrder'
            );
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\V1Order::class
            );
            if (!$response) {
                return [null, $statusCode, $httpHeader];
            }
     ...
     * @param string $payment_id The Square-issued payment ID.
     * payment_id comes from Payment objects returned by the List Payments endpoint,
     * Settlement objects returned by the List Settlements endpoint, or Refund objects returned by the
     * List Refunds endpoint. (required)
     * @return \SquareConnect\Model\V1Payment
     * @throws \SquareConnect\ApiException on non-2xx response
     */
     ...
     * @param string $location_id The ID of the payment&#39;s associated location. (required)
     * @param string $payment_id The Square-issued payment ID.
     * payment_id comes from Payment objects returned by the List Payments endpoint, Settlement objects returned
     * by the List Settlements endpoint, or Refund objects returned by the List Refunds endpoint. (required)
     * @return Array of \SquareConnect\Model\V1Payment, HTTP status code, HTTP response headers (array of strings)
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    public function retrievePaymentWithHttpInfo($location_id, $payment_id)
    {
        ...
        if ($location_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $location_id when calling retrievePayment'
            );
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\V1Payment::class
            );
            if (!$response) {
                return [null, $statusCode, $httpHeader];
            }
     ...
     * retrieveSettlement
     *
     * Provides comprehensive information for a single settlement, including the entries that contribute
     * to the settlement's total.
     *
     * @param string $location_id The ID of the settlements&#39;s associated location. (required)
     * @param string $settlement_id The settlement&#39;s Square-issued ID.
     * You obtain this value from Settlement objects returned by the List Settlements endpoint. (required)
     * @return \SquareConnect\Model\V1Settlement
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    ...
    public function retrieveSettlementWithHttpInfo($location_id, $settlement_id)
    {
        ...
        if ($location_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $location_id when calling retrieveSettlement'
            );
        }
        // verify the required parameter 'settlement_id' is set
        if ($settlement_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $settlement_id when calling retrieveSettlement'
            );
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\V1Settlement::class
            );
            if (!$response) {
                return [null, $statusCode, $httpHeader];
            }
     ...
     * updateOrder
     *
     * Updates the details of an online store order. Every update you perform on an order corresponds
     * to one of three actions:
     *
     * @param string $location_id The ID of the order&#39;s associated location. (required)
     * @param string $order_id The order&#39;s Square-issued ID. You obtain this value from Order objects
     * returned by the List Orders endpoint (required)
     * @param \SquareConnect\Model\V1UpdateOrderRequest $body An object containing the fields to POST for the request.
     * See the corresponding object definition for field details. (required)
     * @return \SquareConnect\Model\V1Order
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    ...
    public function updateOrderWithHttpInfo($location_id, $order_id, $body)
    {
        ...
        if ($location_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $location_id when calling updateOrder'
            );
        }
        // verify the required parameter 'order_id' is set
        if ($order_id === null) {
