...
class InventoryApi
{
     ...
     * BatchChangeInventory
     *
     * @param \SquareConnect\Model\BatchChangeInventoryRequest $body An object containing the fields
     ...
     * @param \SquareConnect\Model\BatchChangeInventoryRequest $body An object containing the fields
     * to POST for the request.  See the corresponding object definition for field details. (required)
     * @return Array of \SquareConnect\Model\BatchChangeInventoryResponse, HTTP status code,
    ...
    public function batchChangeInventoryWithHttpInfo($body)
    {
        ...
        if ($body === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling batchChangeInventory'
            );
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\BatchChangeInventoryResponse::class
            );
            if (!$response) {
     ...
     * BatchRetrieveInventoryChanges
     *
     * @param \SquareConnect\Model\BatchRetrieveInventoryChangesRequest $body An object containing the fields
     * to POST for the request.  See the corresponding object definition for field details. (required)
     ...
     * @param \SquareConnect\Model\BatchRetrieveInventoryChangesRequest $body An object containing the fields
     * to POST for the request.  See the corresponding object definition for field details. (required)
     * @return Array of \SquareConnect\Model\BatchRetrieveInventoryChangesResponse, HTTP status code,
     * HTTP response headers (array of strings)
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    public function batchRetrieveInventoryChangesWithHttpInfo($body)
    {
        ...
        if ($body === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling batchRetrieveInventoryChanges'
            );
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\BatchRetrieveInventoryChangesResponse::class
            );
            if (!$response) {
                return [null, $statusCode, $httpHeader];
            }
     ...
     * BatchRetrieveInventoryCounts
     *
     * @param \SquareConnect\Model\BatchRetrieveInventoryCountsRequest $body An object containing the fields
     * to POST for the request.  See the corresponding object definition for field details. (required)
     ...
     * @param \SquareConnect\Model\BatchRetrieveInventoryCountsRequest $body An object containing the fields
     * to POST for the request.  See the corresponding object definition for field details. (required)
     * @return Array of \SquareConnect\Model\BatchRetrieveInventoryCountsResponse, HTTP status code,
     * HTTP response headers (array of strings)
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    public function batchRetrieveInventoryCountsWithHttpInfo($body)
    {
        ...
        if ($body === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling batchRetrieveInventoryCounts'
            );
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\BatchRetrieveInventoryCountsResponse::class
            );
            if (!$response) {
                return [null, $statusCode, $httpHeader];
            }
     ...
     * RetrieveInventoryAdjustment
     *
     * @param string $adjustment_id The unique id of the [InventoryAdjustment](#type-inventoryadjustment) to retrieve.
     * (required)
     ...
     * @param string $adjustment_id The unique id of the [InventoryAdjustment](#type-inventoryadjustment) to retrieve.
     * (required)
     * @return Array of \SquareConnect\Model\RetrieveInventoryAdjustmentResponse, HTTP status code,
     * HTTP response headers (array of strings)
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    public function retrieveInventoryAdjustmentWithHttpInfo($adjustment_id)
    {
        ...
        if ($adjustment_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $adjustment_id when calling retrieveInventoryAdjustment'
            );
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\RetrieveInventoryAdjustmentResponse::class
            );
            if (!$response) {
                return [null, $statusCode, $httpHeader];
            }
     ...
     * RetrieveInventoryChanges
     *
     * @param string $catalog_object_id The [CatalogObject](#type-catalogobject) id to look up. (required)
     * @param string $location_ids The [Location](#type-location) ids to look up, as a comma-separated list.
     * An empty list queries all locations. (optional)
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->retrieveInventoryChangesWithHttpInfo(
            $catalog_object_id,
            $location_ids,
            $cursor
        );
     ...
     * Provide this to retrieve the next set of results for your original query.
     * See [Paginating results](#paginatingresults) for more information. (optional)
     * @return Array of \SquareConnect\Model\RetrieveInventoryChangesResponse, HTTP status code,
     * HTTP response headers (array of strings)
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    public function retrieveInventoryChangesWithHttpInfo($catalog_object_id, $location_ids = null, $cursor = null)
    {
        ...
        if ($catalog_object_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $catalog_object_id when calling retrieveInventoryChanges'
            );
        }
        ...
        if ($location_ids !== null) {
            $queryParams['location_ids'] = $this->apiClient->getSerializer()
                ->toQueryValue($location_ids);
        }// query params
        if ($cursor !== null) {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\RetrieveInventoryChangesResponse::class
            );
            if (!$response) {
                return [null, $statusCode, $httpHeader];
            }
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->retrieveInventoryCountWithHttpInfo(
            $catalog_object_id,
            $location_ids,
            $cursor
        );
     ...
     * Provide this to retrieve the next set of results for your original query.
     * See [Paginating results](#paginatingresults) for more information. (optional)
     * @return Array of \SquareConnect\Model\RetrieveInventoryCountResponse, HTTP status code,
     * HTTP response headers (array of strings)
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    public function retrieveInventoryCountWithHttpInfo($catalog_object_id, $location_ids = null, $cursor = null)
    {
        ...
        if ($catalog_object_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $catalog_object_id when calling retrieveInventoryCount'
            );
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\RetrieveInventoryCountResponse::class
            );
            if (!$response) {
                return [null, $statusCode, $httpHeader];
            }
     ...
     * RetrieveInventoryPhysicalCount
     *
     * @param string $physical_count_id The unique id of the [InventoryPhysicalCount](#type-inventoryphysicalcount)
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->retrieveInventoryPhysicalCountWithHttpInfo(
            $physical_count_id
        );
        return $response;
    }
     ...
     * @param string $physical_count_id The unique id of the [InventoryPhysicalCount](#type-inventoryphysicalcount)
     * to retrieve. (required)
     * @return Array of \SquareConnect\Model\RetrieveInventoryPhysicalCountResponse, HTTP status code,
     * HTTP response headers (array of strings)
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    public function retrieveInventoryPhysicalCountWithHttpInfo($physical_count_id)
    {
        ...
        if ($physical_count_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $physical_count_id when calling retrieveInventoryPhysicalCount'
            );
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\RetrieveInventoryPhysicalCountResponse::class
            );
            if (!$response) {
                return [null, $statusCode, $httpHeader];
            }
