...
class TransactionsApi
{
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->captureTransactionWithHttpInfo(
            $location_id,
            $transaction_id
        );
        return $response;
     ...
     * @param string $location_id (required)
     * @param string $transaction_id (required)
     * @return Array of \SquareConnect\Model\CaptureTransactionResponse, HTTP status code,
    ...
    public function captureTransactionWithHttpInfo($location_id, $transaction_id)
    {
        ...
        if ($location_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $location_id when calling captureTransaction'
            );
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\CaptureTransactionResponse::class
            );
            if (!$response) {
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->createRefundWithHttpInfo(
            $location_id,
            $transaction_id,
            $body
        );
     ...
     * @param \SquareConnect\Model\CreateRefundRequest $body An object containing the fields to POST for the request.
     * See the corresponding object definition for field details. (required)
     * @return Array of \SquareConnect\Model\CreateRefundResponse, HTTP status code,
     * HTTP response headers (array of strings)
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    public function createRefundWithHttpInfo($location_id, $transaction_id, $body)
    {
        ...
        if ($location_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $location_id when calling createRefund'
            );
        }
        // verify the required parameter 'transaction_id' is set
        if ($transaction_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $transaction_id when calling createRefund'
            );
        }
        // verify the required parameter 'body' is set
        if ($body === null) {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\CreateRefundResponse::class
            );
            if (!$response) {
                return [null, $statusCode, $httpHeader];
            }
     ...
     * @param string $sort_order The order in which results are listed in the response (&#x60;ASC&#x60;
     * for oldest first, &#x60;DESC&#x60; for newest first).  Default value: &#x60;DESC&#x60; (optional)
     ...
     * Provide this to retrieve the next set of results for your original query.
     * See [Paginating results](#paginatingresults) for more information. (optional)
     * @return Array of \SquareConnect\Model\ListRefundsResponse, HTTP status code,
     * HTTP response headers (array of strings)
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    public function listRefundsWithHttpInfo(
        ...
        if ($sort_order !== null) {
            $queryParams['sort_order'] = $this->apiClient->getSerializer()
                ->toQueryValue($sort_order);
        }// query params
        if ($cursor !== null) {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\ListRefundsResponse::class
            );
            if (!$response) {
                return [null, $statusCode, $httpHeader];
            }
    ...
    public function listTransactions(
        ...
        list($response, $statusCode, $httpHeader) = $this->listTransactionsWithHttpInfo(
            $location_id,
            $begin_time,
            $end_time,
            $sort_order,
     ...
     * Provide this to retrieve the next set of results for your original query.
     * See [Paginating results](#paginatingresults) for more information. (optional)
     * @return Array of \SquareConnect\Model\ListTransactionsResponse, HTTP status code,
     * HTTP response headers (array of strings)
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    public function listTransactionsWithHttpInfo(
        ...
        if ($location_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $location_id when calling listTransactions'
            );
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\ListTransactionsResponse::class
            );
            if (!$response) {
                return [null, $statusCode, $httpHeader];
            }
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->retrieveTransactionWithHttpInfo(
            $location_id,
            $transaction_id
        );
        return $response;
     ...
     * @param string $location_id The ID of the transaction&#39;s associated location. (required)
     * @param string $transaction_id The ID of the transaction to retrieve. (required)
     * @return Array of \SquareConnect\Model\RetrieveTransactionResponse, HTTP status code,
     * HTTP response headers (array of strings)
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    public function retrieveTransactionWithHttpInfo($location_id, $transaction_id)
    {
        ...
        if ($location_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $location_id when calling retrieveTransaction'
            );
        }
        // verify the required parameter 'transaction_id' is set
        if ($transaction_id === null) {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\RetrieveTransactionResponse::class
            );
            if (!$response) {
                return [null, $statusCode, $httpHeader];
            }
     ...
     * @param string $location_id (required)
     * @param string $transaction_id (required)
     * @return Array of \SquareConnect\Model\VoidTransactionResponse, HTTP status code,
     * HTTP response headers (array of strings)
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    public function voidTransactionWithHttpInfo($location_id, $transaction_id)
    {
        ...
        if ($location_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $location_id when calling voidTransaction'
            );
        }
        // verify the required parameter 'transaction_id' is set
        if ($transaction_id === null) {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                \SquareConnect\Model\VoidTransactionResponse::class
            );
            if (!$response) {
                return [null, $statusCode, $httpHeader];
            }
